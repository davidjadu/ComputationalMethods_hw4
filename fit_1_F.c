...
void solve_upper_triangular(float *matrix, float *b, float *y, float *v);
void print_in_file(float y, float v);
...
/* FunciÃ³n que resuelve un sistema 2x2 que estÃ¡ en forma triangular superior
 */
void solve_upper_triangular(float *matrix, float *b, float *y, float *v){
  int n=2;
...
/*FunciÃ³n encargada de imprimir los datos en el archivo
 */
void print_in_file(float y, float v){
  char *filename_out="constants_F_data_1.dat";
